...
- [개념과 가치](docs/01-concepts-and-values.md) - ROD, TFD, DGTF의 핵심 개념과 철학
- [실전 가이드](docs/02-practical-guide.md) - 실제 프로젝트에 적용하는 방법
...
- [Concepts and Values](docs/01-concepts-and-values.md) - Core concepts and philosophy of ROD, TFD, DGTF
- [Practical Guide](docs/02-practical-guide.md) - How to apply in real projects
